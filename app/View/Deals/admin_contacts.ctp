<div class="deals index">
    ...
    {?>
        <tr><td><?php echo ++$i;?></td><td><?php echo $contact['Cash']['contact'];?></td><td><?php echo $contact['Cash']['refrence_no'];?></td><td><?php echo $contact['Cash']['total']." AED";?></td><td><?php echo $contact['Cash']['ondate'];?></td>
            <td><?php  if($contact['Cash']['stat']=='0')echo $this->Html->link("Approve","/deals/approved_cash/".$contact['Cash']['id'], array("class"=>'btn btn-success'),"Are you sure taht you want to approve this payment?");else echo "Approved";?></td></tr>     
    <?php
    }?>
