...
<div id="login-account">
            ...
            <!--
                <a href="/deals/usersLogin/facebookAuth" class="facebook-signin">Sign in with Facebook</a>
                ...
                <div class="form-wrap">
                     <?php echo $this->Form->create('User',array('action'=>'login')); ?>
                            <fieldset>
                              ...
                              <div class="form-row">
                                <label class="checkbox"><input type="checkbox" name="check_field">I certify I am at least 18 years old and I have read & agree to the <a href="">Terms & Conditions</a></label>
                                </div>
                        </fieldset>
